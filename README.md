...
- [Mira](https://miracode.ai/) - Self-hosted AI code reviewer for GitHub pull requests using your own LLM key, with whole-repo dependency indexing and team convention learning. ([Source Code](https://github.com/miracodeai/mira)) `Apache-2.0` `Docker`
